...
const Register = () => {
    ...
    const {registerUser, setUser} = useContext(AuthContest)
    ...
    return (
        <div className='mx-4 mb-5'>
            ...
            <div className="flex flex-col space-y-1">
                <h3 className="text-3xl font-bold tracking-tight text-MainBg">Register your account</h3>
            ...
            <div>
                ...
                />
                    ...
                    {
                        password ? <p className='absolute top-10 right-5'><FaEye  size={18}/></p>
                        : 
                        <p className='absolute top-10 right-5'><FaEyeSlash  size={18}/></p>
                    }
                    </div>
                    </div>
                    <button className="rounded-md bg-MainBg w-full px-4 py-2 text-white transition-colors hover:bg-sky-600 dark:bg-sky-700">Register</button>
                </form>
            </div>
        </div>
        </div>
